...
clear all, close all
load('Raleigh20.mat');
[XP,q,aP,zADP] = getADPforCSA20(CSAstr,in);
q = round(q*0.40)+1; % decreasing the demand to 20% of the population
...
while ~done
    ...
    [X,F,out1,X30new] = locateDCnf3(fP,XP,aP,X1,X30,in); % Calculating the DC locations using this function
